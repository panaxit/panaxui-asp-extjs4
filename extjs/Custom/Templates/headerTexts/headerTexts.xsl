...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="PersonaConDiscapacidad[lang('es')]/px:fields/GradoEstudiosInconcluso" mode="headerText">Tiene algún grado de estudios sin concluír</xsl:template>
